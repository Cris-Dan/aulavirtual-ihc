                                        ...
                                        <div className="col s12">
                                            <div className="card azul-oscuro">
                                                ...
                                                <div className="collection ">
                                                    <a href="#!" class="collection-item claro naranja-texto">Verificacion y validacion.pdf</a>
                                                    <a href="#!" class="collection-item claro naranja-texto">LibreriaGLUT.rar</a>
                                                    <a href="#!" class="collection-item claro naranja-texto">Formato para el proyecto.docx</a>
                                                    <a href="#!" class="collection-item claro naranja-texto">Clase 7.pdf</a>
                                                    <a href="#!" class="collection-item claro naranja-texto">Clase 8.pdf</a>
                                                    <a href="#!" class="collection-item claro naranja-texto">Clase 9.pdf</a>
                                                    <a href="#!" class="collection-item claro naranja-texto">Clase 10.pdf</a>
                                                </div>
